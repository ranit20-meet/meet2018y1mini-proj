...
# assigning values to the variables:UP,DOWN,LEFT,RIGHT withe values 0, 1, 2, 3: 
...
# make function up(),down (),left(),and right() that change the veriable direction
# and move the snake according to the key that was pressed:
...
# for small screen:
if screen_size == "small" or small_screen == "tiny" or small_screen == "not too big":   
    UP_EDGE = 260
    DOWN_EDGE = -260
    RIGHT_EDGE = 400
    LEFT_EDGE = -400
...
# for big screeen:
elif screen_size ==  "big" or big_screen == "huge" or big_screen == "enormous":
    UP_EDGE = 520
    DOWN_EDGE = -520
    RIGHT_EDGE = 840
    LEFT_EDGE = -840
...
def move_snake():
    ...
    if new_y_pos <= DOWN_EDGE:
        ...
        quit()
    '''
    # for playing with infinite walls
    if new_x_pos >= RIGHT_EDGE:
